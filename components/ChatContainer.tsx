...
import { ArtifactType } from "./ArtifactsPanel";
import { 
  Send, 
  X, 
  Paperclip,
...
interface ChatContainerProps {
  ...
  onOpenArtifact?: (content: string, type: ArtifactType, title: string) => void;
  isSyncing?: boolean;
  isOffline?: boolean;
}

export function ChatContainer({ currentChat, onUpdateChat, isSyncing = false, isOffline = false }: ChatContainerProps) {
