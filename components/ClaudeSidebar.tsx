            ...
            <div className="flex items-center justify-between">
              ...
              >
                ...
                <div className="flex flex-col">
                  <h1 className="text-sm font-bold text-green-500 tracking-wider uppercase">YYC3 DEV</h1>
                  <span className="text-[10px] text-green-500/50">v.4.0.0-hack</span>
                </div>
              </motion.div>
