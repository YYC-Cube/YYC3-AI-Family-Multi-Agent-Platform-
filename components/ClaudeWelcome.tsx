           ...
           {!isBooted ? (
             ...
             >
               <div className="flex items-center justify-center gap-6 mb-2">
                 <div className="inline-block border border-green-500/30 p-2 bg-green-500/5">
                   <Terminal className="w-10 h-10 text-green-500" />
                 </div>
                 <h1 className="text-4xl md:text-6xl font-bold tracking-tighter glitch-text uppercase">
                   SYSTEM_ONLINE
                 </h1>
               </div>
               <p className="text-green-500/50 text-sm tracking-[0.3em] uppercase">
                 WELCOME BACK, {userName}. WAITING FOR INPUT...
               </p>
             </motion.div>
           )}
        </div>
